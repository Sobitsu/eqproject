	CREATE DATABASE IF NOT EXISTS nps_cb_integration_test CHARACTER SET=utf8;

DROP USER 'nps_test';	#for re-install;

CREATE USER 'nps_test' IDENTIFIED BY '123456';
GRANT all privileges on nps_cb_integration_test.* to nps_test;

USE nps_cb_integration_test;
